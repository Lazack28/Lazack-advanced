module.exports = (m, env) => {
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© mari-wabot'
      ...
      if (!('owners' in setting)) setting.owners = ['6281398274790', '62895385006567', '6285900370695', '16152432839']
      if (!('msg' in setting)) setting.msg = 'Oh hi +tag\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n> ◦ *Database* : +db\n> ◦ *Library* : Baileys\n> ◦ *Rest API* : https://api.ssateam.my.id\n> ◦ *Source* : https://github.com/Im-Dims/mari-wabot\n\nIf you find an error or want to upgrade premium plan contact the owner.'
      if (!isNumber(setting.style)) setting.style = 1
      if (!('cover' in setting)) setting.cover = 'https://iili.io/JEvTjBn.jpg'
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/JDihQ498jwH9UKu8kFaT9N'
   } else {
      global.db.data.setting = {
         ...
         owners: ['6281398274790', '62895385006567', '6285900370695', '16152432839'],
         msg: 'Oh hi +tag\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n> ◦ *Database* : +db\n> ◦ *Library* : Baileys\n> ◦ *Rest API* : https://api.ssateam.my.id\n> ◦ *Source* : https://github.com/Im-Dims/mari-wabot\n\nIf you find an error or want to upgrade premium plan contact the owner.',
         style: 1,
         cover: 'https://iili.io/JEvTjBn.jpg',
